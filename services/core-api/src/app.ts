...
import { categorizeRoute } from './routes/ai/categorize.js';
...
export const buildApp = async (): Promise<ReturnType<typeof Fastify>> => {
  ...
  await app.register(listChecklistTemplatesRoute, { prefix: '/api/v1' });
  ...
  await app.register(categorizeRoute, { prefix: '/api/v1' });
